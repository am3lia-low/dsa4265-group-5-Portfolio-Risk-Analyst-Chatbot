...
\usepackage{graphicx}
\IfFileExists{libertine.sty}{\usepackage{libertine}}{\usepackage{lmodern}}
...
\IfFileExists{caption.sty}{\captionsetup{font=small, labelfont=bf}}{}
...
\begin{titlepage}
    ...
    \vspace*{1.0cm}
    \IfFileExists{figures/nus_logo.jpg}{%
        \includegraphics[width=0.4\textwidth]{figures/nus_logo.jpg}%
    }{%
        \vspace{1.6cm}% Keep title-page spacing when logo is unavailable
    }
